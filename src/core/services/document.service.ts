...
import { DocumentDto, DocumentResponseDto } from "../models/document.model";
...
export class DocumentService {
  ...
  upLoadFile(files: FormData, yearID: number): Observable<Array<DocumentDto>> {
  ...
  delete(id: number): Observable<any> {
    return this.http.delete<any>(`${environment.apiUrl}/document/delete/` + id);
  }
}
